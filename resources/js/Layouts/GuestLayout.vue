...
<template>
            <Disclosure as="nav" class="bg-gray-800" v-slot="{ open }">
                        ...
                        <div class="hidden sm:ml-6 sm:block">
                            ...
                            <div class="hidden sm:ml-6 sm:block">
                                <div class="flex space-x-4">
                                    ...
                                    <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Signin</a>
                                </div>
                            </div>
                ...
                <DisclosurePanel class="sm:hidden">
                    ...
                    <div class="space-y-1 px-2 pb-3 pt-2">
                        <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" -->
                        <DisclosureButton as="a" href="#" class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-gray-700 hover:text-white">Signin</DisclosureButton>
                        <DisclosureButton as="a" href="#" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Sgni up</DisclosureButton>
                    </div>
                </DisclosurePanel>
            </Disclosure>
    <div>
